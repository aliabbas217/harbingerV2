...
export const getAllMessagesByTopicId = async (req, res) => {
    try {
        ...
        const messages = await harbinger.message.findMany({
            where: {
                id: {
                    in: topic.messages.map((message) => message.id),
                },
            },
        });
        if (!messages) {
...
export const deleteAllMessagesByTopicId = async (req, res) => {
    try {
        const { topicId } = req.params;
        const deletedMessages = await harbinger.message.deleteMany({
            where: {
...
export const deleteMessagesByUserId = async (req, res) => {
    try {
...
export const deleteMessageByMessageIdAndUserId = async (req, res) => {
    try {
